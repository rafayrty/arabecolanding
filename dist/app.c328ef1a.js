...
var countDownDate = new Date("Mar 10, 2022 09:00:00").getTime(); // Update the count down every 1 second
...
var x = setInterval(function () {
  ...
  applyTime(days, hours, minutes, seconds); // If the count down is over, write some text 
...
function applyTime(days, hours, minutes, seconds) {
  document.querySelectorAll('.days').forEach(function (elem) {
    elem.innerHTML = days;
  });
  document.querySelectorAll('.hours').forEach(function (elem) {
    elem.innerHTML = hours;
  });
  document.querySelectorAll('.minutes').forEach(function (elem) {
    elem.innerHTML = minutes;
  });
  document.querySelectorAll('.seconds').forEach(function (elem) {
...
},{"gsap":"node_modules/gsap/index.js"}],"C:/Users/abdul/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/abdul/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
